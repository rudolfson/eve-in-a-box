...
import eve.esi.model.GetCharactersCharacterIdWalletJournal200Ok;
import eve.esi.model.GetCharactersCharacterIdWalletTransactions200Ok;
import eve.esi.model.GetCorporationsCorporationIdWallets200Ok;
import eve.esi.model.GetCorporationsCorporationIdWalletsDivisionJournal200Ok;
import eve.esi.model.GetCorporationsCorporationIdWalletsDivisionTransactions200Ok;
...
public class WalletApi {
    ...
    public com.squareup.okhttp.Call getCharactersCharacterIdWalletJournalCall(Integer characterId, String datasource, Long fromId, String token, String userAgent, String xUserAgent, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/v2/characters/{character_id}/wallet/journal/"
            .replaceAll("\\{" + "character_id" + "\\}", apiClient.escapeString(characterId.toString()));
