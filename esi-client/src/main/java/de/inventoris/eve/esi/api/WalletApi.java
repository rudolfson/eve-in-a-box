...
import de.inventoris.eve.esi.model.GetCharactersCharacterIdWalletJournal200Ok;
import de.inventoris.eve.esi.model.GetCharactersCharacterIdWalletTransactions200Ok;
import de.inventoris.eve.esi.model.GetCorporationsCorporationIdWallets200Ok;
import de.inventoris.eve.esi.model.GetCorporationsCorporationIdWalletsDivisionJournal200Ok;
import de.inventoris.eve.esi.model.GetCorporationsCorporationIdWalletsDivisionTransactions200Ok;
...
public class WalletApi {
    ...
    public com.squareup.okhttp.Call getCharactersCharacterIdWalletJournalCall(Integer characterId, String datasource, Long fromId, String token, String userAgent, String xUserAgent, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/v1/characters/{character_id}/wallet/journal/"
            .replaceAll("\\{" + "character_id" + "\\}", apiClient.escapeString(characterId.toString()));
