...
import de.inventoris.eve.esi.model.GetUniverseTypesTypeIdDogmaAttribute;
import de.inventoris.eve.esi.model.GetUniverseTypesTypeIdDogmaEffect;
...
public class GetUniverseTypesTypeIdOk {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(capacity, description, dogmaAttributes, dogmaEffects, graphicId, groupId, iconId, mass, name, portionSize, published, radius, typeId, volume);
  }
