...
public class GetCharactersCharacterIdBlueprints200Ok {
   ...
   * @return itemId
  **/
  @ApiModelProperty(required = true, value = "Unique ID for this item. The ID of an item is stable if that item is not repackaged, stacked, detached from a stack, assembled, or otherwise altered. If an item is changed in one of these ways, then the ID will also change (see notes below).")
   ...
   * @return locationFlag
  **/
  @ApiModelProperty(required = true, value = "Indicates something about this item's storage location. The flag is used to differentiate between hangar divisions, drone bay, fitting location, and similar.")
   ...
   * @return locationId
  **/
  @ApiModelProperty(required = true, value = "References a solar system, station or item_id if this blueprint is located within a container. If an item_id the Character - AssetList API must be queried to find the container using the item_id, from which the correct location of the Blueprint can be derived.")
  ...
  **/
  @ApiModelProperty(required = true, value = "Material Efficiency Level of the blueprint, can be any integer between 0 and 10.")
   ...
   * @return quantity
  **/
  @ApiModelProperty(required = true, value = "Typically will be -1 or -2 designating a singleton item, where -1 is an original and -2 is a copy. It can be a positive integer if it is a stack of blueprint originals fresh from the market (no activities performed on them yet).")
  ...
  **/
  @ApiModelProperty(required = true, value = "Time Efficiency Level of the blueprint, can be any even integer between 0 and 20.")
