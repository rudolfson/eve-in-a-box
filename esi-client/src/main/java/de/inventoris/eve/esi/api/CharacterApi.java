...
import de.inventoris.eve.esi.model.GetCharactersCharacterIdAgentsResearch200Ok;
import de.inventoris.eve.esi.model.GetCharactersCharacterIdBlueprints200Ok;
import de.inventoris.eve.esi.model.GetCharactersCharacterIdChatChannels200Ok;
import de.inventoris.eve.esi.model.GetCharactersCharacterIdCorporationhistory200Ok;
import de.inventoris.eve.esi.model.GetCharactersCharacterIdFatigueOk;
import de.inventoris.eve.esi.model.GetCharactersCharacterIdMedals200Ok;
import de.inventoris.eve.esi.model.GetCharactersCharacterIdNotFound;
import de.inventoris.eve.esi.model.GetCharactersCharacterIdNotifications200Ok;
import de.inventoris.eve.esi.model.GetCharactersCharacterIdNotificationsContacts200Ok;
import de.inventoris.eve.esi.model.GetCharactersCharacterIdOk;
import de.inventoris.eve.esi.model.GetCharactersCharacterIdPortraitNotFound;
import de.inventoris.eve.esi.model.GetCharactersCharacterIdPortraitOk;
import de.inventoris.eve.esi.model.GetCharactersCharacterIdStandings200Ok;
import de.inventoris.eve.esi.model.GetCharactersNames200Ok;
import de.inventoris.eve.esi.model.InternalServerError;
import de.inventoris.eve.esi.model.PostCharactersAffiliation200Ok;
import de.inventoris.eve.esi.model.PostCharactersAffiliationNotFound;
import de.inventoris.eve.esi.model.PostCharactersCharacterIdCspaCharacters;
import de.inventoris.eve.esi.model.PostCharactersCharacterIdCspaCreated;
...
public class CharacterApi {
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call getCharactersCharacterIdBlueprintsCall(Integer characterId, String datasource, String token, String userAgent, String xUserAgent, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
        
        // create path and map variables
        String localVarPath = "/v1/characters/{character_id}/blueprints/"
            .replaceAll("\\{" + "character_id" + "\\}", apiClient.escapeString(characterId.toString()));
    ...
    private com.squareup.okhttp.Call getCharactersCharacterIdBlueprintsValidateBeforeCall(Integer characterId, String datasource, String token, String userAgent, String xUserAgent, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        com.squareup.okhttp.Call call = getCharactersCharacterIdBlueprintsCall(characterId, datasource, token, userAgent, xUserAgent, progressListener, progressRequestListener);
        return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public List<GetCharactersCharacterIdBlueprints200Ok> getCharactersCharacterIdBlueprints(Integer characterId, String datasource, String token, String userAgent, String xUserAgent) throws ApiException {
        ApiResponse<List<GetCharactersCharacterIdBlueprints200Ok>> resp = getCharactersCharacterIdBlueprintsWithHttpInfo(characterId, datasource, token, userAgent, xUserAgent);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<List<GetCharactersCharacterIdBlueprints200Ok>> getCharactersCharacterIdBlueprintsWithHttpInfo(Integer characterId, String datasource, String token, String userAgent, String xUserAgent) throws ApiException {
        com.squareup.okhttp.Call call = getCharactersCharacterIdBlueprintsValidateBeforeCall(characterId, datasource, token, userAgent, xUserAgent, null, null);
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call getCharactersCharacterIdBlueprintsAsync(Integer characterId, String datasource, String token, String userAgent, String xUserAgent, final ApiCallback<List<GetCharactersCharacterIdBlueprints200Ok>> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = getCharactersCharacterIdBlueprintsValidateBeforeCall(characterId, datasource, token, userAgent, xUserAgent, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<List<GetCharactersCharacterIdBlueprints200Ok>>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
    ...
    public com.squareup.okhttp.Call getCharactersCharacterIdRolesCall(Integer characterId, String datasource, String token, String userAgent, String xUserAgent, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/v1/characters/{character_id}/roles/"
            .replaceAll("\\{" + "character_id" + "\\}", apiClient.escapeString(characterId.toString()));
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call postCharactersCharacterIdCspaCall(Integer characterId, PostCharactersCharacterIdCspaCharacters characters, String datasource, String token, String userAgent, String xUserAgent, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = characters;
        
        // create path and map variables
        String localVarPath = "/v3/characters/{character_id}/cspa/"
            .replaceAll("\\{" + "character_id" + "\\}", apiClient.escapeString(characterId.toString()));
