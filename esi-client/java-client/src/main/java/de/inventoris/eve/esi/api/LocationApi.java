...
import de.inventoris.eve.esi.model.GetCharactersCharacterIdLocationOk;
import de.inventoris.eve.esi.model.GetCharactersCharacterIdShipOk;
...
public class LocationApi {
    ...
    public com.squareup.okhttp.Call getCharactersCharacterIdOnlineCall(Integer characterId, String datasource, String token, String userAgent, String xUserAgent, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/v1/characters/{character_id}/online/"
            .replaceAll("\\{" + "character_id" + "\\}", apiClient.escapeString(characterId.toString()));
